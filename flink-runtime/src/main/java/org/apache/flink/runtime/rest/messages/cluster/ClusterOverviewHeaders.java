 ...
 */
public final class ClusterOverviewHeaders implements MessageHeaders<EmptyRequestBody, ClusterOverviewInfo, EmptyMessageParameters> {
	...
	@Override
	public Class<ClusterOverviewInfo> getResponseClass() {
