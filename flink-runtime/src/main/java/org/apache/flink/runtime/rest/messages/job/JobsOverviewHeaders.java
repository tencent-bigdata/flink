 ...
 */
public final class JobsOverviewHeaders implements MessageHeaders<EmptyRequestBody, JobsOverviewInfo, EmptyMessageParameters> {
	...
	@Override
	public Class<JobsOverviewInfo> getResponseClass() {
	...
	public String getDescription() {
		return "Returns an overview over all jobs in the cluster.";
	}
}
