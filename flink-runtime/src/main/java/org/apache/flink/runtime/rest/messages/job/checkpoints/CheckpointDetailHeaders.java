...
/**
 * Headers for the {@link CheckpointDetailHandler}.
 */
public class CheckpointDetailHeaders implements MessageHeaders<EmptyRequestBody, CheckpointDetailInfo, CheckpointMessageParameters> {

	private static final CheckpointDetailHeaders INSTANCE = new CheckpointDetailHeaders();

	public static final String URL = "/jobs/:jobid/checkpoints/:checkpointid";

	private CheckpointDetailHeaders() {}
	...
	@Override
	public Class<CheckpointDetailInfo> getResponseClass() {
	...
	public static CheckpointDetailHeaders getInstance() {
		return INSTANCE;
	}
