 ...
 */
public abstract class AbstractVertexHandler<R extends ResponseBody, M extends VertexMessageParameters> extends AbstractExecutionGraphHandler<R, M> {
	 ...
	 */
	protected AbstractVertexHandler(
