...
import org.apache.flink.runtime.rest.messages.job.TaskIndexPathParameter;
 ...
 * via the "{@link TaskIndexPathParameter#KEY}" in a specific job vertex, (defined
 * via the "{@link VertexIDPathParameter#KEY}" parameter) in a specific job,
 ...
 */
public abstract class AbstractTaskHandler<R extends ResponseBody, M extends TaskMessageParameters> extends AbstractVertexHandler<R, M> {
	...
	protected R handleRequest(
		...
		final Integer subtaskIndex = request.getPathParameter(TaskIndexPathParameter.class);
