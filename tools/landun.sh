...
ARTIFACTS_DIR="${HERE}/artifacts-${STAGE}"
rm -rf $ARTIFACTS_DIR
...
MVN_COMPILE="mvn install -DskipTests $MVN_COMMON_OPTIONS $MVN_COMPILE_MODULES"
...
cd $HERE
tar -cvzf "artifacts-$STAGE.tar.gz" "artifacts-$STAGE"
